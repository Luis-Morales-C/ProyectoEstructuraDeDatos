...
<<<<<<< Updated upstream:src/main/java/Controllers/AdminProcessesController.java
...
=======
                Process process = items.get(i); // Accede al proceso actual
                row.createCell(0).setCellValue(process.getId());       // ID del proceso
                row.createCell(1).setCellValue(process.getName());     // Nombre del proceso
                row.createCell(2).setCellValue(process.getMinTime());  // Tiempo mínimo
                row.createCell(3).setCellValue(process.getMaxTime());  // Tiempo máximo
>>>>>>> Stashed changes:src/main/java/Proceso/Controllers/AdminProcessesController.java
            }
