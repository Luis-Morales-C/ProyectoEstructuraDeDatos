...
public class Tool {
    ...
    public void notifyUser(String message){
        if ((AppController.INSTANCE.getUsuarioActual().getNotificationType().equals(NotificationType.MAIL))) {
            Mail mail = new Mail(AppController.INSTANCE.getUsuarioActual().getMail(), "Notificacion", message);
            mail.sendMail();
        }else
            Platform.runLater(() -> {
